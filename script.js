...
(function(){
  ...
  /* Participa form panel (overlays/extends over the image, closed by default) */
  ...
  var visual = panel.closest('.participa-visual');

  function openPanel(){
    panel.classList.add('open');
    if(visual){ visual.classList.add('open'); }
    toggle.setAttribute('aria-expanded', 'true');
  }
  function closePanel(){
    panel.classList.remove('open');
    if(visual){ visual.classList.remove('open'); }
